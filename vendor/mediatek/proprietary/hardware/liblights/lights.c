...
/* Vanzo:luanshijun on: Fri, 22 May 2015 14:49:33 +0800
 * add breathlight support
 */
#ifdef VANZO_FEATURE_BREATH_LIGHT_SUPPORT
static int g_haveBreathLight = 0;
char const*const BREATH_LIGHT_FILE = "/sys/class/breathlightdrv/breathlight/open";
#endif
...
/* Vanzo:luanshijun on: Fri, 22 May 2015 14:56:34 +0800
 * add breathlight support
 */
#ifdef VANZO_FEATURE_BREATH_LIGHT_SUPPORT
    g_haveBreathLight = (access(BREATH_LIGHT_FILE, W_OK) == 0) ? 1 : 0;
#endif
// End of Vanzo:luanshijun
}
...
/* Vanzo:luanshijun on: Fri, 22 May 2015 14:57:38 +0800
 * add breathlight support
 */
#ifdef VANZO_FEATURE_BREATH_LIGHT_SUPPORT
static int
set_light_breath(struct light_device_t* dev,struct light_state_t const* state)
{
    int err = 0;
    pthread_mutex_lock(&g_lock);
    if (g_haveBreathLight) {
        err = write_int(BREATH_LIGHT_FILE, state->color); // state->color is action for breath light 
    }
...
/* Vanzo:luanshijun on: Fri, 22 May 2015 15:17:50 +0800
 * add breathlight support
 */
#ifdef VANZO_FEATURE_BREATH_LIGHT_SUPPORT
    else if (0 == strcmp(LIGHT_ID_BREATH, name)) {
        set_light = set_light_breath;
    }
#endif
// End of Vanzo:luanshijun
    else {
