...
protected:
     ...
     , m_eSensorDev(eSensorDev)
    {
        ...
        if (m_eSensorDev == ESensorDev_Main) {
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture, eSoftwareScenario_Main2_Normal_Stream);    
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_MultiPass_ANR_1, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_MultiPass_ANR_2, eSoftwareScenario_Main2_Normal_Stream);
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_Capture_SWNR, eSoftwareScenario_Main2_Normal_Stream); 
            ...
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Capture_EE_Off, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Capture_EE_Off_SWNR, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Blending_All_Off, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_Blending_All_Off_SWNR, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_EE_Off, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_ANR_EE, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_ANR_EE_SWNR, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_Mixing, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_PostProc_Mixing_SWNR, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_MultiPass_ANR_1, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_VSS_MFB_MultiPass_ANR_2, eSoftwareScenario_Main2_Normal_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture, eSoftwareScenario_Main2_N3D_Stream);
            INIT_ISP_DRV_SCENARIO(EIspProfile_PureRAW_TPipe_Capture_SWNR, eSoftwareScenario_Main2_N3D_Stream);
        } 
