...
//isp line buffer
#define CAM_RRZ_MAX_LINE_BUFFER_IN_PIXEL (3072)
//
...
class IspDrvShell:virtual public IspDrv_B
{
    ...
    public://commandQ operation
        ...
        mutable Mutex   gP1StopLock;    //for p1 disable lock, p1/p1_d share the same lock to prevent racing issue at hw_reset
