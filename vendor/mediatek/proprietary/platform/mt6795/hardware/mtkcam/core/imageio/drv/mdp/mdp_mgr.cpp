...
MINT32 MdpMgrImp::startMdp(MDPMGR_CFG_STRUCT cfgData)
{
    ...
    LOG_INF("+,cqIndx(%u),sceID(%u),cqPA(0x%x),tpipVa(0x%x),tpipPa(0x%x),isWaitBuf(%d),venc(%d),nbc_Scal(%d),enDbg(%d)", \
            ...
            cfgData.isWaitBuf,cfgData.dstPortCfg[ISP_MDP_DL_VENCO],cfgData.ispTpipeCfgInfo.nbc.anr_scale_mode,cfgData.ispTpipeCfgInfo.drvinfo.debugRegDump);
	//_startMdp
