...
if (ENABLE_ISPTUNE & m_3ACtrlEnable) {
    ...
    MINT32 iValidateOpt = rParamIspProfile.iValidateOpt & 0x3;

    if (iValidateOpt != ParamIspProfile_T::EParamValidate_None)
    {
        if (fgPerframe)
        {
            AaaTimer rTm;
        ...
        if (iValidateOpt == ParamIspProfile_T::EParamValidate_All)
        {
            AaaTimer rTm;
...
MBOOL Hal3A::postCommand(ECmd_T const eCmd, MINTPTR const i4Arg)
{
	...
	bRet = sem_wait_relativeTime(&semPDThdEnd, SEM_TIME_LIMIT_NS, "postCommand::semPDThdEnd");
		...
		bRet = sem_wait_relativeTime(&semPDVCThdEnd, SEM_TIME_LIMIT_NS, "postCommand::semPDVCThdEnd");
...
{ 
    ...
    // white level (12bit)
    rDngInfo.i4SensorInfoWhiteLevel = 4095;
    ...
    if (fgPureRaw)
    {
        ...
        {
        case SENSOR_FORMAT_ORDER_RAW_B:
            rDngInfo.i4SensorBlackLevelPattern[3] = obc.offst3.bits.OBC_OFST_R;
            rDngInfo.i4SensorBlackLevelPattern[2] = obc.offst1.bits.OBC_OFST_GR;
            rDngInfo.i4SensorBlackLevelPattern[1] = obc.offst2.bits.OBC_OFST_GB;
            rDngInfo.i4SensorBlackLevelPattern[0] = obc.offst0.bits.OBC_OFST_B;
            break;
        case SENSOR_FORMAT_ORDER_RAW_Gb:
            rDngInfo.i4SensorBlackLevelPattern[2] = obc.offst3.bits.OBC_OFST_R;
            rDngInfo.i4SensorBlackLevelPattern[3] = obc.offst1.bits.OBC_OFST_GR;
            rDngInfo.i4SensorBlackLevelPattern[0] = obc.offst2.bits.OBC_OFST_GB;
            rDngInfo.i4SensorBlackLevelPattern[1] = obc.offst0.bits.OBC_OFST_B;
            break;
        case SENSOR_FORMAT_ORDER_RAW_Gr:
            rDngInfo.i4SensorBlackLevelPattern[1] = obc.offst3.bits.OBC_OFST_R;
            rDngInfo.i4SensorBlackLevelPattern[0] = obc.offst1.bits.OBC_OFST_GR;
            rDngInfo.i4SensorBlackLevelPattern[3] = obc.offst2.bits.OBC_OFST_GB;
            rDngInfo.i4SensorBlackLevelPattern[2] = obc.offst0.bits.OBC_OFST_B;
            break;
        default:
        case SENSOR_FORMAT_ORDER_RAW_R:
            rDngInfo.i4SensorBlackLevelPattern[0] = obc.offst3.bits.OBC_OFST_R;
            rDngInfo.i4SensorBlackLevelPattern[1] = obc.offst1.bits.OBC_OFST_GR;
            rDngInfo.i4SensorBlackLevelPattern[2] = obc.offst2.bits.OBC_OFST_GB;
            rDngInfo.i4SensorBlackLevelPattern[3] = obc.offst0.bits.OBC_OFST_B;
            break;
        }
    ...
    // lens shading map
    rDngInfo.vecShadingMap.resize(4);
