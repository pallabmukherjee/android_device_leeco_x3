...
public:
    ...
    virtual bool postCommand(MUINTPTR buf_addr, MUINT32 buf_size, MUINT64 buf_timestamp)= 0;
    virtual void setCallbacks(sp<CamMsgCbInfo> const& rpCamMsgCbInfo) = 0;
    virtual int setWidth(MUINT32 w) = 0;
    virtual int setHeight(MUINT32 h) = 0;
	virtual int setStrides(MUINT32 s)=0;
//    virtual int getMaxBufferCount(MUINT32 buf_size) = 0;
};
