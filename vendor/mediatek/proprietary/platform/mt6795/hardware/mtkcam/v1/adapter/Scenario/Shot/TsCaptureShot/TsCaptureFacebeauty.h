...
class TsCaptureFacebeauty : public ImpShot
{
public:
...
public:     ////    Interfaces.
    ...
    TsCaptureFacebeauty(char const*const pszShotName, uint32_t const u4ShotMode, int32_t const i4OpenId);
    TsCaptureFacebeauty(IImageBuffer* SrcImgBuffer, IImageBuffer* DstImgBuffer);
    virtual ~TsCaptureFacebeauty()  {}
