    ...
    //
    {
        ...
        else
        {
            if(ioctl(fd, READ_DEV_DATA, &devinfo_data) == 0)
            {
                ...
                isp_bonding = (devinfo_data >> 24) & 0x3;
                if(isp_bonding != 0x0)
                {
                    ...
                    switch(isp_bonding){
                        case 1: // 16M
                            ...
                            {
                                ISP_Limit =MTRUE;
                                //MY_LOGD("Warning!NOT Full function chip(%d)",isp_bonding);
                            }
                            break;
                        case 2: // 13M
                        case 3: // 13M
        ...
        if (ISP_Limit == MTRUE) {
            MY_LOGE("Warning!NOT Full function chip(%d)",isp_bonding);
            //return MFALSE;
        }
    }
