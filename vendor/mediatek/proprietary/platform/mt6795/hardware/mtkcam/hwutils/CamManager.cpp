...
incDevice()
{
    ...
    //
    if( mDeviceCnt == 2 ) {
        MY_LOGD("enable thermal policy");
        system("/system/bin/thermal_manager thermal_policy_01 1");
    }
}
...
decDevice()
{
    ...
    //
    if( mDeviceCnt == 1 ) {
        MY_LOGD("disable thermal policy");
        system("/system/bin/thermal_manager thermal_policy_01 0");
    }
}
