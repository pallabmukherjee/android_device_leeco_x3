...
#define MAX_ISP_TILE_TDR_HEX_NO 3584 /*(MAX_TILE_TOT_NO*MAX_ISP_DUMP_HEX_PER_TILE)*/
...
CMD(a, b, c, d, e, cfa.bayer_bypass, REG_CMP_EQ(c, LOG_CFA_EN, 1), 0x150048A0, 0x00000001, 0, CAM_CFA_BYPASS, BAYER_BYPASS)\
CMD(a, b, c, d, e, cfa.dm_fg_mode, REG_CMP_EQ(c, LOG_CFA_EN, 1), 0x150048A0, 0x00000010, 4, CAM_CFA_BYPASS, CFA_FG_MODE)\
...
CMD(a, b, c, d, e, g2c.g2c_shade_en, REG_CMP_EQ(c, LOG_G2C_EN, 1), 0x15004BB8, 0x00000001, 0, CAM_G2C_SHADE_CON_1, G2C_SHADE_EN)\
...
CMD(a, b, c, d, e, srz2.srz_horizontal_coeff_step, REG_CMP_EQ(c, LOG_SRZ2_EN, 1), 0x15004C60, 0x0007FFFF, 0, CAM_SRZ2_HORI_STEP, SRZ2_HORI_STEP)\
CMD(a, b, c, d, e, srz2.srz_vertical_coeff_step, REG_CMP_EQ(c, LOG_SRZ2_EN, 1), 0x15004C64, 0x0007FFFF, 0, CAM_SRZ2_VERT_STEP, SRZ2_VERT_STEP)\
