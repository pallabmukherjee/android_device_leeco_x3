...
/* Vanzo:hanshengpeng on: Thu, 22 Jan 2015 16:42:21 +0800
 * control default preview size
 */
                if (!FeatureSwitcher.isFrontCameraPreviewFullscreen() && mCameraId == 1
                        || !FeatureSwitcher.isBackCameraPreviewFullscreen() && mCameraId == 0)
