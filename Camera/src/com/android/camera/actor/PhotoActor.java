...
public class PhotoActor extends CameraActor implements FocusManager.Listener,
    ...
    public void onShutterButtonClick(ShutterButton button) {
        ...
        if (!(CameraActivity.STATE_SWITCHING_CAMERA == cameraState
                || CameraActivity.STATE_PREVIEW_STOPPED == cameraState) && mICameraAppUi.updateRemainStorage() > 0) {
...
/* Vanzo:hanshengpeng on: Thu, 22 Jan 2015 21:28:56 +0800
 * camera volume hook key can capture
 */
        ...
        case KeyEvent.KEYCODE_HEADSETHOOK:
            if (!FeatureSwitcher.isKeyVolumeHookCapture())
                break;
...
/* Vanzo:hanshengpeng on: Fri, 23 Jan 2015 10:56:06 +0800
 * for camera volume hook key can capture,remove cshot
