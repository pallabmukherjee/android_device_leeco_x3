...
/* Vanzo:hanshengpeng on: Thu, 22 Jan 2015 21:51:26 +0800
 ...
 */
        sImageFileNamer = new ImageFileNamer(context.getString(R.string.image_file_name_format), context);
...
/* Vanzo:hanshengpeng on: Thu, 22 Jan 2015 20:44:14 +0800
 * custom config camera img,video file name
        public ImageFileNamer(String format) {
 */
        public ImageFileNamer(String format, Context ctx) {
            final String fileNameHead = FeatureSwitcher.getFileHeadName();
            if (format != null && fileNameHead != null
                    && fileNameHead != "") {
                format = format.replace("IMG", fileNameHead);
                format = format.replace("VID", fileNameHead);
                format = format.replace("LIV", fileNameHead);
            }
// End of Vanzo:hanshengpeng
