...
/* Vanzo:wuhonghai on: Mon, 10 Aug 2015 11:00:02 +0800
 * Camera:rm focus sound
                    mListener.playSound(MediaActionSound.FOCUS_COMPLETE);
 */
                    if (!com.android.featureoption.FeatureOption.VANZO_FEATURE_REMOVE_CAMERA_FOCUS_SOUND) {
                        mListener.playSound(MediaActionSound.FOCUS_COMPLETE);
                    }
// End of Vanzo:wuhonghai
                }
            } else {
                mState = STATE_FAIL;
            }
    ...
    public void updateFocusUI() {
        ...
        if (mState == STATE_IDLE || mState == STATE_UNKNOWN) {
            ...
            if (mState == STATE_SUCCESS) {
                if (mParameters != null && Parameters.FOCUS_MODE_AUTO.equals(mContext.getParameters().getFocusMode()) 
                        && "on".equals(mContext.getParameters().getDistanceMode()) && !faceExists) {
