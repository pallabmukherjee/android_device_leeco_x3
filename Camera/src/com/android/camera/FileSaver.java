...
/* Vanzo:hanshengpeng on: Mon, 26 Jan 2015 20:47:46 +0800
 */
...
/* Vanzo:hanshengpeng on: Thu, 22 Jan 2015 21:49:58 +0800
 * custom config camera img,video file name
                    mContext.getString(R.string.image_file_name_format));
 */
                    mContext.getString(R.string.image_file_name_format), mContext);
// End of Vanzo:hanshengpeng
...
/* Vanzo:hanshengpeng on: Thu, 22 Jan 2015 21:50:22 +0800
 * custom config camera img,video file name
                    new ImageFileNamer(mContext.getString(R.string.video_file_name_format)));
 */
                    new ImageFileNamer(mContext.getString(R.string.video_file_name_format), mContext));
// End of Vanzo:hanshengpeng
            mFileNamer.put(Storage.FILE_TYPE_LIV,
/* Vanzo:hanshengpeng on: Thu, 22 Jan 2015 21:50:40 +0800
 * custom config camera img,video file name
                    new ImageFileNamer(mContext.getString(R.string.livephoto_file_name_format)));
 */
                    new ImageFileNamer(mContext.getString(R.string.livephoto_file_name_format), mContext));
// End of Vanzo:hanshengpeng
        }
    ...
    private class PhotoOperator extends RequestOperator {
        ...
        private void saveImageToSDCard(String tempFilePath, String filePath, byte[] data) {
            ...
            try {
                ...
                out.write(data);
                out.close();
/* Vanzo:hanshengpeng on: Mon, 26 Jan 2015 20:20:23 +0800
 * add feature, time stamp
 */
                if (mContext.getEnableTimeStamp())
                    dealPhotoFile(tempFilePath);
// End of Vanzo:hanshengpeng
...
/* Vanzo:hanshengpeng on: Mon, 26 Jan 2015 20:43:17 +0800
 * add feature, time stamp
 */
        ...
        private String getCurrTime(String pattern) {
            if (pattern == null) {
