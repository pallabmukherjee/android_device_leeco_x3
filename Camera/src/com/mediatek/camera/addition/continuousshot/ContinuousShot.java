...
/* Vanzo:luanshijun on: Mon, 27 Apr 2015 22:52:45 +0800
 * show cuntinue capture menu
 */
        if (mICameraContext.getFeatureConfig().isLowRamOptSupport() && !com.android.featureoption.FeatureOption.VANZO_FEATURE_SHOW_CONTINUE_CAPTURE_MENU) {
// End of Vanzo:luanshijun
            mMaxCaptureNum = DEFAULT_CONINUOUS_CAPTURE_NUM;
        } else {
            // get mMaxCaptureNum from setting controller
/* Vanzo:zhongjunyu on: Mon, 22 Jun 2015 14:51:56 +0800
 * implement#112862,avoid camera crash
            mMaxCaptureNum = Integer.valueOf(mISettingCtrl
                    .getSettingValue(SettingConstants.KEY_CONTINUOUS_NUMBER));
 */
            mMaxCaptureNum = Integer.valueOf(mISettingCtrl
                    .getSettingValue(SettingConstants.KEY_CONTINUOUS_NUMBER) == null ? mActivity
                    .getString(R.string.pref_camera_continuous_number_default) : mISettingCtrl
                    .getSettingValue(SettingConstants.KEY_CONTINUOUS_NUMBER));
    ...
    private class MainHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case RESTART_PREVIEW:
                if (mListener != null) {
                    if (getCurrentState() ==  State.STATE_OPENED) {
/* Vanzo:hanshengpeng on: Tue, 17 Mar 2015 17:39:15 +0800
 * add this line for cshot crash debug
 */
                        Log.e(TAG, "[handleMessage]restartPreview is called @@@");
