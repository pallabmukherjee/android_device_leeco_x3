...
/* Vanzo:hanshengpeng on: Fri, 23 Jan 2015 20:47:08 +0800
 */
...
/* Vanzo:hanshengpeng on: Fri, 23 Jan 2015 16:53:08 +0800
 * add feature,mute shutter sound switch & time stamp
 */
        case SettingConstants.ROW_SETTING_MUTE_SHUTTER_SOUND:
            if (!FeatureSwitcher.isSupportCaptureSoundSwitch()) {
                removePreference = true;
            } else {
                removePreference = false;
            }
            break;
        case SettingConstants.ROW_SETTING_TIME_STAMP:
            if (!FeatureSwitcher.isSupportTimeStampSwitch()) {
                removePreference = true;
            } else {
                removePreference = false;
            }
...
/* Vanzo:luanshijun on: Mon, 27 Apr 2015 22:57:40 +0800
 *  add continue menu
 */
                if(com.android.featureoption.FeatureOption.VANZO_FEATURE_SHOW_CONTINUE_CAPTURE_MENU){
                      removePreference = false;
                } else {
                      removePreference = true;
                }
// End of Vanzo:luanshijun
        ...
        case SettingConstants.ROW_SETTING_DUAL_CAMERA_MODE:
            ...
            break;
/* Vanzo:yuecaili on: Fri, 24 Jul 2015 20:34:17 +0800
 * implement #113060: VANZO_FEATURE_CAMERA_SETTINGS_REMOVE_EIS
 */
        case SettingConstants.ROW_SETTING_VIDEO_STABLE:
            if(FeatureOption.VANZO_FEATURE_CAMERA_SETTINGS_REMOVE_EIS){
                removePreference = true;
            }
            break;
