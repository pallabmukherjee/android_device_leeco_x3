...
/* Vanzo:hanshengpeng on: Mon, 26 Jan 2015 20:56:02 +0800
 * add feature, time stamp
 */
    private boolean mEnableTimeStamp = false;
...
/* Vanzo:hanshengpeng on: Mon, 26 Jan 2015 16:45:05 +0800
 * add feature,mute shutter sound switch & time stamp
 */
            } else if (SettingConstants.KEY_MUTE_SHUTTER_SOUND.equals(key)) {
                boolean enable = "on".equals(value) ? true : false;
                mICameraDevice.setEnableShutterSound(enable);
            } else if (SettingConstants.KEY_TIME_STAMP.equals(key)) {
                boolean enable = "on".equals(value) ? true : false;
                setEnableTimeStamp(enable);
// End of Vanzo:hanshengpeng
            } else {
...
/* Vanzo:hanshengpeng on: Mon, 26 Jan 2015 20:54:57 +0800
 * add feature, time stamp
 */
    public boolean getEnableTimeStamp() {
        return mEnableTimeStamp;
    }
