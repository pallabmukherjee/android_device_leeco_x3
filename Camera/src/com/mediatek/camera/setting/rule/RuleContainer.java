...
public class RuleContainer {
    ...
    public void addRule() {
        ...
        StereoPictureRule fastPictureSize = new StereoPictureRule(SettingConstants.KEY_FAST_AF);
        mISettingCtrl.addRule(SettingConstants.KEY_FAST_AF,
                SettingConstants.KEY_PICTURE_RATIO, fastPictureSize);
        
        StereoPictureRule distancePictureSize = new StereoPictureRule(SettingConstants.KEY_DISTANCE);
        mISettingCtrl.addRule(SettingConstants.KEY_DISTANCE,
                SettingConstants.KEY_PICTURE_RATIO, distancePictureSize);
    ...
    private class StereoPictureRule implements ISettingRule {
        private SettingItem mCurrentSettingItem;
        private String mSettingKey;
        public StereoPictureRule(String settingkey) {
            mSettingKey = settingkey;
            mCurrentSettingItem = mISettingCtrl.getSetting(mSettingKey);
            Log.i("iniTAG","mCurrentSettingItem  = " + mCurrentSettingItem);
        }
        ...
        public void execute() {
            ...
            if ("on".equals(currentValue)) {
                ...
                if (mPictureRatioSetting.isEnable()) {
                    ...
                    SettingUtils.setPreviewSize(mICameraContext.getActivity(), parameters, overrideValue);
                }
                
                Record record = mPictureRatioSetting.new Record(resultValue, overrideValue);
                mPictureRatioSetting.addOverrideRecord(mSettingKey, record);
            } else {
                mPictureRatioSetting.removeOverrideRecord(mSettingKey);
                ...
                if (count > 0) {
                    ...
                    mPictureRatioSetting.setValue(resultValue);
                    SettingUtils.setPreviewSize(mICameraContext.getActivity(), parameters, resultValue);
                }
