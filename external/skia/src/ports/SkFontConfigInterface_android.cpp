...
/* Vanzo:zhangjingzhi on: Wed, 10 Jun 2015 09:42:55 +0800
...
/* Vanzo:zhangjingzhi on: Wed, 10 Jun 2015 09:43:14 +0800
 * for 3rd VANZO_FEATURE_LOVELYFONTS_SUPPORT
 */
#ifdef VANZO_FEATURE_LOVELYFONTS_SUPPORT
            char value[PROPERTY_VALUE_MAX];
            property_get("persist.sys.lovelyfonts.path", value, "");
            if (*value != 0 && strcmp(filename.c_str(), "/system/fonts/Roboto-Regular.ttf") == 0) {
                filename = value;
            }
#endif
// End of Vanzo:zhangjingzhi
